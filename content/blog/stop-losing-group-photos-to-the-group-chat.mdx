...
Everything stays [private to the people you share the link with](/help/who-can-see-your-event), and it's yours to keep — no expiry clock. When you're ready, [start a free event](/login) and send the link instead of starting another doomed group-chat thread.
