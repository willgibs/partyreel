...
- The album's ambient pieces (the phone's screen cycle, the Live | Review photograph, the lightbox pill): three decisions on the `loose-ends` board (cut 2026-09-18), judged on Will's screen.
