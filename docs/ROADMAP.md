...
- Verify a change-plan session `[eng]` at the live cutover (TEST verified 2026-09-23 on partyreel.com: a Pro Checkout with the 4242 card provisioned Pro 100 GB through both webhooks, and Change plan opened Stripe's confirm page for one price at quantity 1, Back returned to the app, Confirm billed the $10.00 proration and the webhook raised the cap to 500 GB): the same walk once in live mode.
