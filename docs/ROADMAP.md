...
- `docs/PRICING.md`'s "Follow-up (code)" line says the Resend-code button has no cooldown; `email-sign-in.tsx` ships a 60 s `RESEND_COOLDOWN_S`: delete the line.
...
- **Billing follow-ons:**
  ...
  - A full [`PRD.md`](PRD.md) refresh to the shipped product.
