...
| The record is a snapshot; git is the history | a docs/CHANGELOG.md (what shipped is the merge commits and git log), a STATUS over 120 lines without its round section, a CLAUDE.md over 150 lines. | `src/lib/record-depth-policy.test.ts:1` |
