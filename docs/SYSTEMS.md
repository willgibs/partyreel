...
| **Billing & caps** | The entitlement engine: the storage-cap model (`host_active_bytes`, monthly ingress), video gating, Stripe checkout/portal/webhook + provisioning, the Event Pass ledger (stacking + prorated Pro credit) | [billing-caps.md](systems/billing-caps.md) | [0025](adr/0025-event-pass-economics.md) (+ [PRICING.md](PRICING.md)) |
