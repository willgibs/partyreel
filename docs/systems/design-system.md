...
decision recorded here is precedent, not law (Will's "less is more" ruling, 2026-09-12).
...
**A lamp that crosses a chapter cut is clipped at the cut.** Light stopping dead there was the ruling, not
...
"Partyreel" and /press's "Press" take it. **ONE OR TWO WORDS ONLY** (bible 6; Will's contract, 2026-08-29),
...
**THE FLOATING-LAYER CONTRACT** (bible 15) (named 2026-08-28 when the nav turned out to be the one menu
...
**THE ARRIVAL-DEFAULT CONTRACT (bible 13; generalized 2026-08-28, the /blog round): the VISIBLE state is the
...
Moved, and still the default an agent leaves on purpose: the craft stack and the skills now live
in [`docs/design/guidance.md`](../design/guidance.md), rendered at `/design/library/guidance`, with
the rest of the rule set around them (the levels, the law, the policies). Guidance is a level, not
a chapter of what shipped, so it belongs in the design rule set rather than here.
