...
merged: "d31c5312"      # the branch head merged into launch-prep
...
- Head: `c25775f9` on `lp/palette`, pushed (the last code commit is `62ce6072`, the
  launch-prep merge; the commits after it are this manifest). No preview: `preview: false`, and no `[preview]` or
