...
| `door-fixes` | integrated at `11453841` (handed off `46d9353d`; the three overrides folded in by message, verified against the committed rulings); re-checked on the alias at `36fcde3c` 00:50 EDT 2026-09-22: four of five hold, the pending-heal 200 converted to a 304 by Vercel's edge and cut as `heal-validator` | done | Sonnet, :3135 | nothing |
