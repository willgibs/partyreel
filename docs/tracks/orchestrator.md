...
| `door-steps` | integrated at `cc9e7da8` (handed off `ce3ce0d0`; five declared exceptions outside owns; four Opus API drops survived by message); red-teamed on the alias at `27ff8a9e` by 23:18 EDT: every case holds, two small defects cut as `door-fixes` | done | Opus, :3132 | nothing |
