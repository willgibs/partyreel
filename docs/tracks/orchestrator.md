...
| --- | --- | --- | --- |
| `lab-review-card` | `/design/lab/<board>?session=` (the review card, the clarity round) | none: a local `pnpm dev` (integrated, merged `0829c12d`) | nothing: the answering happens on the board now |
| `palette` | `/design/lab/palette` (the clarity round, round 6: the first catalog) | none: a local `pnpm dev` (integrated, merged `99544a2b`) | Will's pick among twelve palettes, then three follow-ups, through the desk |
| `album-hero` | `/design/lab/album-hero` (the clarity round, round 3: the asks in plain words) | none: a local `pnpm dev` (integrated, merged `63240eac`) | Will's five asks, in plain words, through the desk |
...
| `floating-surfaces` | `/design/lab/floating-surfaces` (the clarity round, round 6) | none: a local `pnpm dev` (integrated, merged `b9a32cba`) | Will's five asks, in plain words, through the desk |
...
| `home-hero` | `/design/lab/home-hero` (the clarity round, round 6) | none: a local `pnpm dev` (integrated, merged `f438190d`) | Will's four asks, in plain words, through the desk |
| `media-kit` | `/design/lab/media-kit` (the clarity round, round 6) | none: a local `pnpm dev` (integrated, merged `7617d6b4`) | Will's four asks, in plain words, through the desk |
| `river-visual` | `/design/lab/river-visual` (the clarity round, round 3) | none: a local `pnpm dev` (integrated, merged `bea5ace8`) | Will's four asks, in plain words, through the desk |
...
| `type-scale` | `/design/lab/type-scale` (the clarity round, round 6) | none: a local `pnpm dev` (integrated, merged `bfab66c1`) | Will's four asks, in plain words, through the desk |
