...
| `toasts-wiring` | cut at the toasts record: the Toaster at the top under the bar, expanded, errors persisting until dismissed, one trailing action slot, the card material as today; `toasts` retires | running | Sonnet, :3131 | the top band's offset per surface his to overrule |
