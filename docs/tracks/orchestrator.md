...
| `voice-wiring` | cut at the fifth batch's record (2026-09-20): the eight ruled lines to production, bible 20 rewritten by the Orchestrator, `voice` retires; owns the copy homes and `content/` | open | Opus, :3131 | the handoff; the merge retires the board and its ledger |
...
| `overtaken` | cut after `lab-tides` merges: the desk mechanism his ruling asks for (badge, one agent line, "the ruling stands", overrides echoed) and the judgment lines for the ~25 asks his rulings reach | queued | Opus, :3136 | cut the hour `lab-tides` lands |
...
0. **Batch five (2026-09-20, the night sitting; the plan in the Orchestrator's plan file, his words in rulings.md):**
   ...
   ruling once the hub lands. At each handoff: the merge (`voice-wiring` retires its board and ledger; a round-two lane rewrites its
