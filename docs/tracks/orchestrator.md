...
| `heal-validator` | integrated at `9f3d489c` (handed off `69c7c5f4`) | done | Sonnet, :3136 | the alias proof once it moves: the matching-validator curl answering 200 with the cookie and no ETag |
