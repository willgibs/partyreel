...
announces:
  ...
  - "The desk's order (2026-09-19, Will): `BOARDS` in `sandbox/registry.ts` is ordered by LEVERAGE, the board whose answer changes another's question above it, independent boards at the foot; the desk and the board paging follow it. A lane still adds a new board at the HEAD (merges stay line-disjoint) and the Orchestrator moves it into its place at the next record; a lane never reorders the list."
---
