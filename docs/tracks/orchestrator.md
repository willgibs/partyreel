...
| `reel-and-copy` | the count at one ("1 photo or video"), Settings' default look and hold as NULL, a never-picked reel view following Set for everyone live | building (agent `a1594bc95e3c39c40`) | Sonnet, :3133 | its reel and guest-flow lines through the Handoff |
