...
-- three CREATE OR REPLACEs are signature-identical, behavior-compatible amendments (every
...
-- runs. Same body as 20260604031713 plus the hold refusal; the reason string falls into the
-- wrapper's DEFAULT branch ("That item is no longer available.") — deliberately discreet, a
-- reporter/abuser must not learn a hold exists from the copy.
