  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onClick}
        className="pointer-events-auto flex h-11 items-center gap-3 rounded-full bg-primary px-5 text-sm font-medium text-primary-foreground shadow-[0_6px_16px_rgba(0,0,0,0.18)] transition-[transform,opacity] duration-200 ease-emphasis outline-none focus-visible:ring-2 focus-visible:ring-ring active:scale-[0.97] motion-reduce:active:scale-100 motion-safe:starting:translate-y-2 motion-safe:starting:opacity-0"
      >
