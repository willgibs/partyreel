...
/**
 * THE MARQUEE: the Reel section once a reel exists (host-app.md, "Reel curation,
 * the live composer, and the .mp4 export").
 *
 * R3 gave the reel a FACE in the feed. R3.1 took away everything else. The
 * alias review of the shipped build found that a feed section is a VISUAL surface
 ...
 * composition that was already rejected. The pre-Create builder is untouched: quick-add,
  ...
  return (
    <div className="space-y-3">
      {/* The section's own status row. The chip lives HERE and not in the feed's
          ...
          Studio door sits beside it because the floating action bar (the
