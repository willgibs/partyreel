...
describe("scatteredTimeline (Remotion ScatteredPrints parity)", () => {
  ...
  const PINS: TPin[] = [
    { frame: 0, lift: 0, heroFloat: 0, heroPress: 0, boardDim: 1, boardScale: 1, boardBlur: 0 },
    { frame: 117, lift: 0, heroFloat: 0, heroPress: 0, boardDim: 1, boardScale: 1, boardBlur: 0 },
    // The wind-up press over the hero beat, before the lift releases.
    { frame: 147, lift: 0, heroFloat: 0, heroPress: 0.2, boardDim: 1, boardScale: 1, boardBlur: 0 },
    // Mid-lift: the board dims/recedes/softens while the press eases out.
    { frame: 167, lift: 0.877174, heroFloat: 0, heroPress: 0.122826, boardDim: 0.929826, boardScale: 0.986842, boardBlur: 2.463105 },
    { frame: 175, lift: 0.971779, heroFloat: 0, heroPress: 0.028221, boardDim: 0.922258, boardScale: 0.985423, boardBlur: 2.728756 },
    // Fully lifted: the hero float breathes in (eased from zero amplitude AND phase).
    { frame: 200, lift: 1, heroFloat: 0.078857, heroPress: 0, boardDim: 0.92, boardScale: 0.985, boardBlur: 2.808 },
    { frame: 216, lift: 1, heroFloat: 3.2207, heroPress: 0, boardDim: 0.92, boardScale: 0.985, boardBlur: 2.808 },
  ];
...
describe("scatteredPrintState (Remotion ScatteredPrints parity)", () => {
  ...
  const PINS: PPin[] = [
    { frame: 0, i: 0, lift: 0, anticip: 0, p: 0, cx: 0.56698, cy: 0.455831, tx: 0, ty: -453.6, rot: -7.985813, sc: 1.1, op: 0, squash: 1, mountW: 596.14717, mountH: 452.659619, photoW: 554.924227, photoH: 396.374448 },
    { frame: 8, i: 0, lift: 0, anticip: 0, p: 1.005993, cx: 0.56698, cy: 0.455831, tx: 0, ty: 2.718548, rot: 4.086106, sc: 0.999401, op: 1, squash: 1, mountW: 596.14717, mountH: 452.659619, photoW: 554.924227, photoH: 396.374448 },
    { frame: 100, i: 5, lift: 0, anticip: 0, p: 1.001445, cx: 0.9, cy: 0.346104, tx: 0.156034, ty: 0.187241, rot: 7.031736, sc: 0.999856, op: 1, squash: 1, mountW: 564.559076, mountH: 428.674511, photoW: 525.520416, photoH: 375.371726 },
    { frame: 216, i: 3, lift: 0, anticip: 0, p: 1, cx: 0.710031, cy: 0.727716, tx: 0, ty: 0, rot: 8.216044, sc: 1, op: 1, squash: 1, mountW: 433.022217, mountH: 328.797455, photoW: 403.079192, photoH: 287.913708 },
    // The HERO at full lift: risen, straightened to level, grown to 1.18x, nudged toward center.
    { frame: 216, i: 7, lift: 1, anticip: 0, p: 1, cx: 0.5, cy: 0.46, tx: 0, ty: -54, rot: 0, sc: 1.18, op: 1, squash: 1, mountW: 682.2144, mountH: 518.0112, photoW: 635.04, photoH: 453.6 },
  ];
...
describe("scatteredGroundShadow (lifting-paper physics parity)", () => {
  ...
  it("matches the full-lift reference (ps 453.6, settled, lift 1): detached + spread", () => {
    expect(scatteredGroundShadow(453.6, 1, 1, 0.9)).toEqual([
      { dx: 0, dy: 1.8144000000000002, blur: 2.72, color: "rgba(46,30,12,0.050)" },
