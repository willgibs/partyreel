...
const PINS: Pin[] = [
  ...
  { frame: 0, i: 0, p: 0, tx: 0, ty: -2304, rot: -17.985813, sc: 1.12, op: 0, squashY: 1, dev: 0, kb: 1.02, zLift: 0.45 },
  { frame: 4, i: 0, p: 0.686689, tx: 5.568975, ty: -697.023314, rot: -2.878649, sc: 1.037597, op: 1, squashY: 1, dev: 0, kb: 1.022424, zLift: 0.45 },
  { frame: 10, i: 0, p: 1.02918, tx: 8.346537, ty: 104.466502, rot: 4.656145, sc: 0.996498, op: 1, squashY: 1, dev: 0.075758, kb: 1.026061, zLift: 0.45 },
  // i1 slides in from the left edge (the ~40% slide-in toss variant).
  { frame: 26, i: 1, p: 0.686689, tx: -347.887561, ty: -68.461565, rot: 0.41405, sc: 1.046491, op: 1, squashY: 1, dev: 0, kb: 1.022424, zLift: 0.528571 },
  { frame: 40, i: 1, p: 0.999373, tx: -63.698096, ty: 5.277066, rot: 4.791623, sc: 1.008647, op: 1, squashY: 1, dev: 0.378788, kb: 1.030909, zLift: 0.528571 },
  { frame: 60, i: 2, p: 1.001511, tx: -13.470993, ty: 7.68104, rot: 4.190982, sc: 1.016958, op: 1, squashY: 1, dev: 0.30303, kb: 1.029697, zLift: 0.607143 },
  // i5 at its exact dropStart (local 0): present but not yet visible.
  { frame: 110, i: 5, p: 0, tx: -972, ty: -230.4, rot: -6.950927, sc: 1.168, op: 0, squashY: 1, dev: 0, kb: 1.02, zLift: 0.842857 },
  // i7 (the top print) at its dropStart and fully settled on the reel's last frame.
  { frame: 154, i: 7, p: 0, tx: 972, ty: -230.4, rot: 21.242231, sc: 1.1872, op: 0, squashY: 1, dev: 0, kb: 1.02, zLift: 1 },
  { frame: 221, i: 7, p: 1, tx: 69.19186, ty: -126.958979, rot: 7.242231, sc: 1.06, op: 1, squashY: 1, dev: 1, kb: 1.06, zLift: 1 },
];
