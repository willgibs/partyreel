/**
 * The GUEST reel payload: the pure contract surface of the guest reel read (R3, ADR-0022 ruling 5).
 *
...
/**
 * Names that must NEVER appear on the anon surface (ADR-0022 ruling 5's "never returned" list).
