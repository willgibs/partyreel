          ...
          <Container>
            <div className="mx-auto flex max-w-5xl flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
              <div className="max-w-2xl min-w-0">
                ...
                <article
                  id={ARTICLE_BODY_ID}
                  className="prose max-w-none prose-help prose-headings:font-heading prose-code:font-sans prose-code:font-medium [&>p:first-child]:text-[1.0625rem] [&>p:first-child]:leading-[1.7]"
                >
                  {content}
                </article>
