...
export const FOUNDATION_ENTRIES: GalleryEntry[] = [
  {
    ...
    family: "foundations",
    section: "Light",
    lede: "The coloured light of the house, in three kept forms: the SEAM, a band where two grounds meet; the THROW, cast from a point on an object; the FIELD, a whole chapter lit at its own two edges. One engine, the same five hues, one clock. Never on a light ground.",
    play: "glow",
    variants: [
      {
        prop: "shape",
        ...
        note: "The recipe, and the only required prop. Two of the five are Aurora forms (the seam, the throw); the field is two seams, mounted by SectionLight. A sweep travels, a bloom is a one-shot and a halo rings the object.",
      },
      {
        prop: "drive",
        source: "prop",
    ...
    specimens: [
      ...
      },
      {
        ...
        label: "The field",
        hint: "<SectionLight> · 42% of the section at each edge · 24s, three laps of the lamp clock",
        bleed: true,
        node: (
