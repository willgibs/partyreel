  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-6 pt-8 pb-20">
      ...
      <RefSection
        ...
        blurb="The pending review, now INLINE in the event feed (the pop-up takeover is retired): the dense triage grid + its select mode (Select / Approve all, then the bulk bar). A reliable auth-free HYDRATION probe for the review island; the bulk actions themselves need auth, so they no-op here."
      >
        <ReviewSectionDemo />
      </RefSection>
