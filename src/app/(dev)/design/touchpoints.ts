...
export const RULINGS: Ruling[] = [
  ...
  },
  {
    ...
    surface: "shared",
    asks:
      "how a new photo enters the justified rows, what the five size steps look like and whether phones get them, and whether the rows break now and then for a feature",
