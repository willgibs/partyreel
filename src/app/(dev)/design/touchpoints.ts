...
export const RULINGS: Ruling[] = [
  ...
  },
  {
    ...
    surface: "shared",
    asks: "how a new photo enters the justified rows, what the size steps look like and whether phones get them, and whether the rows break now and then for a feature",
    why: "Round two's picks (the push, the slider with pinch, the taller row) are built as a windowed, opt-in rows layout with three steps, until the surfaces switch.",
    lives: [
