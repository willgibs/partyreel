...
export const RULINGS: Ruling[] = [
  {
    ...
    surface: "guest",
    asks: "where the optional email sits against the name, where a member's sign-in lives, how the verified gate frames its benefit, what the guest's own menu says, and where undoing an email lives",
  ...
  },
  {
    ...
    surface: "guest",
    asks: "how a verified guest sets up her page, how she chooses what shows, when the app offers the setup, and what an empty page says to a visitor",
  ...
  },
  {
    ...
    surface: "guest",
    asks: "when the second ask to keep her photos reaches a guest the door already offered an email, the ask's shape, whom she can follow once she confirms, and whether her typed name gets one look before it becomes her account's",
  ...
  },
  {
    ...
    surface: "marketing",
    asks: "the footer beneath a page's own closing call to action: its register, a page with none above it, and the phone",
  ...
  },
  {
    ...
    surface: "guest",
    asks: "how the full guest list opens from the faces row, what a name opens first, and how a profile keeps the scanned event reachable",
  ...
  },
  {
    ...
    surface: "guest",
    asks: "the creator a guest meets from the reel: the way in, the room, the fourteen looks, the moments, a hidden tile, the export's wait, the finish, the free mark, and a device that cannot encode",
  ...
  },
  {
    ...
    surface: "marketing",
    asks: "which way a photograph reaches the album on the /features/album hero: Glide, Gather or Cascade",
  ...
  },
  {
    ...
    surface: "marketing",
    asks: "the privacy page's hero: a breathing aperture, a grid whose tiles take turns clearing, or sealed cards that lift",
