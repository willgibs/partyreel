import { Calendar, Heart, ImageUp, Plus, Settings, Share2, Trash2 } from "lucide-react";
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid w-72 gap-1 p-2 text-sm">
                    <li className="rounded-md px-3 py-2 hover:bg-muted">Uploads</li>
                    <li className="rounded-md px-3 py-2 hover:bg-muted">Curation</li>
                    <li className="rounded-md px-3 py-2 hover:bg-muted">Sharing</li>
                  </ul>
                </NavigationMenuContent>
              </NavigationMenuItem>
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid w-72 gap-1 p-2 text-sm">
                    <li className="rounded-md px-3 py-2 hover:bg-muted">Weddings</li>
                    <li className="rounded-md px-3 py-2 hover:bg-muted">Parties</li>
                  </ul>
                </NavigationMenuContent>
              </NavigationMenuItem>
              <NavigationMenuItem>
