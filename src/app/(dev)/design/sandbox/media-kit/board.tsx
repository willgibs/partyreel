...
/**
 * THE MEDIA-KIT BOARD (the review wave, 2026-09-14). A STUB: the Orchestrator registered
 * the board so the `media-kit` track owns only this directory; the track
 * replaces everything below. The brief, the facts and the lane are in
 * docs/tracks/media-kit.md; the shell (Stage, Toggle, BoardMeta) is
 * src/components/dev/board/. Keyframes live in board.css under `mk-`.
...
const ASKS = [
  "The licensing rule as written (author, source and retrieval date on every entry)",
  "The sources allowed, clause by clause",
  "The first batch: OK or not, item by item, beside the current twelve",
  "The kit plan: the shot lists by vertical, the clips, the posters",
];
      ...
      >
        <Stage mode={mode} ground="paper" height={CANVAS[mode].h / 2}>
          <div className="flex h-full items-center justify-center p-8 text-center text-sm text-muted-foreground">
            The media-kit board is being built on its own preview; candidates
            land here.
          </div>
        </Stage>
      </Variant>
