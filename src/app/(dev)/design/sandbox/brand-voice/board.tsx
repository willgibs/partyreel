...
/**
 * THE BRAND-VOICE BOARD (the review wave, 2026-09-14). A STUB: the Orchestrator registered
 * the board so the `brand-voice` track owns only this directory; the track
 * replaces everything below. The brief, the facts and the lane are in
 * docs/tracks/brand-voice.md; the shell (Stage, Toggle, BoardMeta) is
 * src/components/dev/board/. Keyframes live in board.css under `bv-`.
...
const ASKS = [
  "The voice: the guide's paragraph and its three registers",
  "The seven provisional home headers in the proposed voice",
  "The account-required unfurl line: asks for an email, or asks to sign in with an email",
  "The five copy-alternative picks",
];
      ...
      >
        <Stage mode={mode} ground="cinema" height={CANVAS[mode].h / 2}>
          <div className="flex h-full items-center justify-center p-8 text-center text-sm text-muted-foreground">
            The brand-voice board is being built on its own preview; candidates
            land here.
          </div>
        </Stage>
      </Variant>
