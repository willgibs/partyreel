...
export default async function AccountPage({
  ...
  // The pre-regen typing seam: profiles.bio arrives with migration
  // 20260919120000 and src/lib/db/types.ts is regenerated by the Orchestrator
  // after it applies, so the row is read structurally until then. Drop the cast
  // at that point. Pre-apply it reads null and the field saves nothing, which
  // is the same graceful pre-apply stance every social read on this page takes.
  const bio = (profile as { bio?: string | null }).bio ?? null;
