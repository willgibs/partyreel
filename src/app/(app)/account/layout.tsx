...
// THE NAME GATE for /account. Until this gate, a
// nameless profile rendered /account normally — the one gap: "an account
// without a name wasn't moving around the app as a normal user."
// /account can no longer
