...
import type { ReelClip, ReelProps } from "../src/reel-types";
import { THEME_CLASSIC } from "../src/reel-types";

const { R2_ACCOUNT_ID, R2_ACCESS_KEY_ID, R2_SECRET_ACCESS_KEY, R2_BUCKET } =
  process.env;
if (!R2_ACCOUNT_ID || !R2_ACCESS_KEY_ID || !R2_SECRET_ACCESS_KEY || !R2_BUCKET) {
  throw new Error("Set R2_ACCOUNT_ID/ACCESS_KEY_ID/SECRET_ACCESS_KEY/BUCKET in workers/reel-render/.env");
}
...
type Item = { type: "photo" | "video"; key: string; trimStartSec?: number; trimDurationSec?: number };
const items: Item[] = [
  { type: "photo", key: `${E}/photo/eea04b91-17eb-4424-9095-8d42e437311e/original.jpg` },
  { type: "photo", key: `${E}/photo/21285cf7-271a-410b-bded-f63f6eb0a079/original.jpg` },
  { type: "video", key: `${E}/video/dc2540eb-3d41-4848-8f45-23414a60781d/original.mp4`, trimStartSec: 0.5, trimDurationSec: 3 },
  { type: "photo", key: `${E}/photo/df9894b2-590c-49ae-8959-37c2e93a3bac/original.jpg` },
  { type: "photo", key: `${E}/photo/11234cd7-9f05-4a7f-91c1-ac95ffba7602/original.jpg` },
  { type: "video", key: `${E}/video/bccd26cd-5560-4f4c-b52d-5da15478eda9/original.mp4`, trimStartSec: 1, trimDurationSec: 3 },
  { type: "photo", key: `${E}/photo/dc3d53e5-66eb-4f0d-98c7-b4d14147b49a/original.jpg` },
  { type: "photo", key: `${E}/photo/90908db2-83e4-411a-9237-303aca6b43d4/original.jpg` },
];
...
async function main() {
  ...
  console.log(`Wrote out/props.json — ${clips.length} clips (presigned ${TTL_SECONDS / 3600}h)`);
}
