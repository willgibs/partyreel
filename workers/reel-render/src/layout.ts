...
// Pure timeline layout — shared by calculateMetadata (total duration) and the component (per-clip
// placement), so the duration the composition reports always matches what it actually renders.
//
