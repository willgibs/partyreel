...
FIXES={"third-batch-fixes","identity-fixes","door-fixes","heal-validator","guest-email-migration","guest-email-server","guest-email-door","guest-email-claims","identity-copy-fixes","name-gate","identity-door","identity-claims","identity-profile","reel-engine-live","reel-engine-video","reel-view","reel-front","reel-screen","reel-cut","reel-host","reel-story"}
...
OWNS.update({"reel-cut":["src/app/(dev)/design/sandbox/reel-cut/"],"reel-host":["src/app/(dev)/design/sandbox/reel-host/"],"reel-story":["src/app/(dev)/design/sandbox/reel-story/"]})
READS.update({"reel-cut":["src/components/reel/reel-studio.tsx","src/components/reel/studio-moments-picker.tsx","src/components/reel/style-rail.tsx","src/components/reel/reel-stitching-dialog.tsx","src/components/guest/guest-reel-overlay.tsx","src/lib/reel/engine/","src/app/(dev)/design/sandbox/guest-capture/","src/app/(dev)/design/sandbox/gallery-fixtures.ts","src/components/lab/","src/app/(dev)/design/touchpoints.ts","docs/design/rulings.md","docs/systems/host-app.md"],"reel-host":["src/app/(app)/dashboard/[eventId]/page.tsx","src/components/app/event-settings/event-settings-sheet.tsx","src/app/(app)/dashboard/page.tsx","src/components/app/share/event-sheets.tsx","src/app/(dev)/design/sandbox/host-curation/","src/app/(dev)/design/sandbox/gallery-fixtures.ts","src/components/lab/","src/app/(dev)/design/touchpoints.ts","docs/design/rulings.md","docs/systems/host-app.md"],"reel-story":["src/components/marketing/sections/reel/","src/components/marketing/sections/home/reel-teaser.tsx","src/lib/constants/marketing-voice.ts","src/lib/constants/features.ts","src/lib/constants/how-it-works.ts","src/lib/constants/events.ts","src/components/marketing/sections/pricing/","src/app/(dev)/design/sandbox/gallery-fixtures.ts","src/components/lab/","src/app/(dev)/design/touchpoints.ts","docs/design/rulings.md","docs/systems/marketing-content.md","docs/ASSETS.md"]})
BOARD.update({"reel-cut":"reel-cut        # a new board: the reel round, the creator","reel-host":"reel-host       # a new board: the reel round, the host's side","reel-story":"reel-story      # a new board: the reel round, the marketing story"})
LANE_SECTION.update({"reel-cut":r"Lane 86: `reel-cut`","reel-host":r"Lane 87: `reel-host`","reel-story":r"Lane 88: `reel-story`"})
