...
`launch-prep` preview alias** (`https://partyreel-git-launch-prep-willgibs.vercel.app`, allow-listed in
Supabase/R2 like prod); partyreel.com is verified at milestone merges.
